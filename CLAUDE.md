...
| [`backend/app/services/harness/phase_types.py`](docs/HOT-FILE-LEDGER.md#backendappservicesharnessphase_typespy) | 38 / 15 / 2393 | **FIRES** | extraction due — not taken in 190 (no 2nd concern) |
...
| [`frontend/src/pages/WorkflowBuilderPage.tsx`](docs/HOT-FILE-LEDGER.md#frontendsrcpagesworkflowbuilderpagetsx) | 41 / 12 / 2348 | **FIRES** | honoured by construction (193.1 / 193.2) |
| [`backend/app/api/workflows.py`](docs/HOT-FILE-LEDGER.md#backendappapiworkflowspy) | 35 / 17 / 1962 | **FIRES** | extraction due — not taken in q5r (no 2nd concern) |
...
| [`frontend/src/components/workflows/PhaseFormPanel.tsx`](docs/HOT-FILE-LEDGER.md#frontendsrccomponentsworkflowsphaseformpaneltsx) | 16 / 8 / 1167 | **FIRES** | honoured by construction ×3 (185 / 193 / 193.1) |
...
| [`backend/app/services/harness/publish_service.py`](docs/HOT-FILE-LEDGER.md#backendappservicesharnesspublish_servicepy) | 19 / 7 / 1243 | **FIRES** | honoured by construction (193.2) |
