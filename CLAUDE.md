...
| [`frontend/src/pages/WorkflowRunPage.tsx`](docs/HOT-FILE-LEDGER.md#frontendsrcpagesworkflowrunpagetsx) | 15 / 5 / 1197 | **FIRES** | **one of five named seams TAKEN (195)** — the deliverable list; four remain, named in the detail file. ⚠ row read `12 / 3 / 1101 · at threshold` and went stale the SAME DAY |
...
| [`frontend/src/components/panel/PhaseCard.tsx`](docs/HOT-FILE-LEDGER.md#frontendsrccomponentspanelphasecardtsx) | 12 / 8 / 543 | ⚠ **FIRES** | ⚠ **was ABSENT at SEVEN phases** (196) — ⚠ `SUBSTEP_META` must stay TOTAL over `EmitSubStep` |
