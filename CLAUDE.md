...
| [`backend/app/api/sources.py`](docs/HOT-FILE-LEDGER.md#backendappapisourcespy) | 5 / 1 / 643 | no (1 phase) | ⚠ row was STALE at `2 / 0 / 356` — **+287 L**. ✅ 235 fixed `/sync`: it REFUSES when the LIVE reader is absent and reports the outcome (`BUG-260906-02`) |
