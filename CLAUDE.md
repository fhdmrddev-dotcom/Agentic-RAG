...
| `frontend/src/components/layout/ChatLayout.tsx` | 53 / 28 / 1095 | honoured by construction (**262-05**): 3 imports + ONE last-but-one branch + ONE prop forward. ⛔ the fallback stays LAST — order IS the guard; `folders` is a 4th consumer of ONE read |
