...
| [`frontend/src/pages/LibraryPage.tsx`](docs/HOT-FILE-LEDGER.md#frontendsrcpageslibrarypagetsx) | 27 / 10 / 603 | ⚠ **FIRES** | ✅ **the rename is TAKEN (217-04)** — `IngestionPage.tsx` → `LibraryPage.tsx`, history follows. ⚠ **the named seam is still OWED**; 217-09 takes it. Re-derive with `git log --follow` |
