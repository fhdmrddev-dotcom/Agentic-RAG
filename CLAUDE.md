...
| [`backend/app/services/harness/phase_types.py`](docs/HOT-FILE-LEDGER.md#backendappservicesharnessphase_typespy) | 47 / 21 / 2664 | **FIRES** | extraction TAKEN (200-03) · honoured by construction (211). ✅ `BUG-260827-01` CLOSED 2026-08-27 (`/gsd:fast`, G-3) — the G-5 obligation is now OWED, not honoured |
...
| [`backend/app/services/harness/grounding.py`](docs/HOT-FILE-LEDGER.md#backendappservicesharnessgroundingpy) | 19 / 6 / 1311 | **FIRES** | honoured by construction (193.1, **211**) — 211 changed the connection's AXIS, never the closed capability set; empty diff across the phase |
...
| [`frontend/src/components/settings/ConnectionsTab.tsx`](docs/HOT-FILE-LEDGER.md#frontendsrccomponentssettingsconnectionstabtsx) | 13 / 5 / 1414 | ⚠ **FIRES — EXACTLY AT THRESHOLD** | honoured by construction (212) |
...
| [`frontend/src/components/settings/connectionMark.tsx`](docs/HOT-FILE-LEDGER.md#frontendsrccomponentssettingsconnectionmarktsx) | 4 / 2 / 217 | no (2 phases) | young (206.1-01, 212) |
...
| [`frontend/src/components/workflows/McpToolPicker.tsx`](docs/HOT-FILE-LEDGER.md#frontendsrccomponentsworkflowsmcptoolpickertsx) | 3 / 3 / 645 | ⚠ **FIRES — EXACTLY AT THRESHOLD** | honoured by construction (211) — ⚠ the row read `2 / 2 / 570` and a disposition that was itself out of date |
