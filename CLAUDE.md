...
| [`backend/app/db/watches.py`](docs/HOT-FILE-LEDGER.md#backendappdbwatchespy) | 2 / 2 / 634 | no (2 phases) | ⚠ row was STALE at `1 / 1 / 439`. 235 added the sync-run store + the retention prune; ⛔ the prune's bound is proven against FIXTURES only, never live rows |
