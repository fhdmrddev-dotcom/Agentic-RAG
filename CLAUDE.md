...
| [`backend/app/services/retrieval_service.py`](docs/HOT-FILE-LEDGER.md#backendappservicesretrievalservicepy) | 17 / 9 / 362 | ⚠ **FIRES** | honoured by construction (**231**) — the widening landed in the SQL it CALLS, file byte-unchanged. ⚠ extraction still OWED; it drops the per-hit similarity (`SEED-224`) |
