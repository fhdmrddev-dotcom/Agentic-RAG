...
| [`backend/app/services/harness/phase_types.py`](docs/HOT-FILE-LEDGER.md#backendappservicesharnessphase_typespy) | 46 / 21 / 2627 | **FIRES** | extraction TAKEN (200-03) · honoured by construction (211) — 211 moved the axis and edited NOTHING here, empty diff. ⚠ it carries `BUG-260827-01` |
