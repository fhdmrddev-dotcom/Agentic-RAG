...
| [`backend/app/services/harness/phase_types.py`](docs/HOT-FILE-LEDGER.md#backendappservicesharnessphase_typespy) | 50 / 23 / 2809 | **FIRES** | extraction TAKEN (200-03) · honoured by construction (211 / **214**) — ⚠ the G-5 obligation stays **OWED** |
...
| [`frontend/src/pages/WorkflowBuilderPage.tsx`](docs/HOT-FILE-LEDGER.md#frontendsrcpagesworkflowbuilderpagetsx) | 55 / 20 / 2956 | **FIRES** | honoured by construction ×5 (193.1 / 193.2 / 197 / 200.3 / **214**) |
...
| [`backend/app/services/workflow_authoring.py`](docs/HOT-FILE-LEDGER.md#backendappservicesworkflow_authoringpy) | 14 / 8 / 881 | **FIRES** | honoured by construction (193.2 / 197 / **214**) |
...
| [`frontend/src/types/index.ts`](docs/HOT-FILE-LEDGER.md#frontendsrctypesindexts) | 71 / 57 / 1203 | ⚠ **FIRES** | no seam proposed — a barrel of wire types; ⚠ absent until 196, at 56 phases (214) |
...
| [`scripts/vitest-count-gate.cjs`](docs/HOT-FILE-LEDGER.md#scriptsvitest-count-gatecjs) | 124 / 24 / 4045 | ⚠ **FIRES** | honoured by construction (**214-15**) — BASELINE pins and one TARGETS check, no logic change; ⚠ absent until 196, at 16 phases |
...
| [`frontend/src/components/workflows/soulData.ts`](docs/HOT-FILE-LEDGER.md#frontendsrccomponentsworkflowssouldatats) | 11 / 9 / 465 | ⚠ **FIRES** | honoured by construction (**214**); ⚠ absent until 197, at 7 phases |
...
| [`frontend/src/pages/SettingsPage.tsx`](docs/HOT-FILE-LEDGER.md#frontendsrcpagessettingspagetsx) | 34 / 21 / 1426 | ⚠ **FIRES** | ⚠ absent for its ENTIRE LIFE — row added 2026-08-27 at 212's close. ⚠ its re-open trigger did NOT fire (212 never named it); this closes a known gap, it does not discharge the trigger |
...
| [`frontend/src/components/workflows/LaunchInputFields.tsx`](docs/HOT-FILE-LEDGER.md#frontendsrccomponentsworkflowslaunchinputfieldstsx) | 1 / 1 / 91 | no (1 phase) | young (214-09 / 214-12) — **the ONE declared-input renderer three doors mount** |
...
| [`frontend/src/lib/api/workflows.ts`](docs/HOT-FILE-LEDGER.md#frontendsrclibapiworkflowsts) | 3 / 3 / 1055 | ⚠ **FIRES — EXACTLY AT THRESHOLD** | ⚠ absent for its entire life; the 207 split created it with NO row. **`lib/api.ts`'s row is the BARREL, not these modules** |
