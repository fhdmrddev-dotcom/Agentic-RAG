...
| [`scripts/vitest-count-gate.cjs`](docs/HOT-FILE-LEDGER.md#scriptsvitest-count-gatecjs) | 133 / 27 / 4439 | ⚠ **FIRES** | honoured by construction (214-15 / 214.1-02 / **SEED-227**) — BASELINE pins + one TARGETS line, NO logic/threshold/check change; ⚠ absent until 196, at 16 phases |
...
| [`frontend/src/components/settings/ConnectionFormPanel.tsx`](docs/HOT-FILE-LEDGER.md#frontendsrccomponentssettingsconnectionformpaneltsx) | 15 / 6 / 2316 | ⚠ **FIRES** | ⚠ the row was STALE at `9 / 5 / 2009`. honoured by construction (212 / **221**) — 221-01 adds ONE prop at the one mount site |
| [`frontend/src/components/settings/ConnectionGrantsList.tsx`](docs/HOT-FILE-LEDGER.md#frontendsrccomponentssettingsconnectiongrantslisttsx) | 4 / 1 / 344 | no (1 phase) | ⚠ absent for its ENTIRE LIFE — row added **221**, the phase that changes it most. Seam TAKEN by construction: it must SHRINK, never double |
...
| [`backend/app/services/connectors/service_tools.py`](docs/HOT-FILE-LEDGER.md#backendappservicesconnectorsservice_toolspy) | 6 / 0 / 1456 | no (0 phases) | ⚠ absent for its ENTIRE LIFE — row added 221. Its bucket list is ALL dated quick tasks, so it measures 0 phases at 1456 L |
...
| [`frontend/src/components/settings/connectionsCopy.ts`](docs/HOT-FILE-LEDGER.md#frontendsrccomponentssettingsconnectionscopyts) | 12 / 6 / 638 | ⚠ **FIRES** | no seam proposed — a vocabulary doing one thing many times is the right shape |
...
| [`backend/app/services/connector_service.py`](docs/HOT-FILE-LEDGER.md#backendappservicesconnector_servicepy) | 16 / 5 / 1461 | ⚠ **FIRES** | ⚠ the row was STALE at `7 / 3 / 1149` — +9 commits, +2 phases, +312 L unrecorded. honoured by construction (211 / **221**) |
...
| [`backend/app/services/tool_dispatcher.py`](docs/HOT-FILE-LEDGER.md#backendappservicestool_dispatcherpy) | 72 / 29 / 4624 | ⚠ **FIRES** | honoured by construction (2026-08-31) — the org resolution EXTRACTED to `connectors/org_scope.py`; ⚠ the row was STALE at `67 / 28 / 4336` after ONE day |
