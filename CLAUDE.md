...
| [`backend/app/api/connectors.py`](docs/HOT-FILE-LEDGER.md#backendappapiconnectorspy) | 17 / 7 / 1338 | ⚠ **FIRES** | ⚠ the row was STALE at `7 / 3 / 781`. **221-02 adds the THIRD check arm** — an OAuth row was refused 409 about a live token |
