...
| [`frontend/src/pages/WorkflowBuilderPage.tsx`](docs/HOT-FILE-LEDGER.md#frontendsrcpagesworkflowbuilderpagetsx) | 42 / 13 / 2398 | **FIRES** | honoured by construction (193.1 / 193.2) |
| [`backend/app/api/workflows.py`](docs/HOT-FILE-LEDGER.md#backendappapiworkflowspy) | 36 / 18 / 1984 | **FIRES** | extraction due — not taken in q5r (no 2nd concern) |
| [`backend/app/services/harness/grounding.py`](docs/HOT-FILE-LEDGER.md#backendappservicesharnessgroundingpy) | 18 / 5 / 1252 | **FIRES** | honoured by construction (193.1) |
...
| [`backend/app/services/workflow_authoring.py`](docs/HOT-FILE-LEDGER.md#backendappservicesworkflow_authoringpy) | 12 / 6 / 572 | **FIRES** | honoured by construction (193.2) |
...
| [`frontend/src/components/workflows/builderStore.ts`](docs/HOT-FILE-LEDGER.md#frontendsrccomponentsworkflowsbuilderstorets) | 11 / 5 / 837 | **FIRES** | honoured by construction (193.2) |
...
| [`frontend/src/lib/api.ts`](docs/HOT-FILE-LEDGER.md#frontendsrclibapits) | 170 / 97 / 6154 | ⚠ **FIRES HARDEST** | ⚠ **the HOTTEST file in the repository — and it was ABSENT from this table at NINETY-SEVEN phases** (196). Refutes the `threads.py` superlative below |
...
| [`scripts/vitest-count-gate.cjs`](docs/HOT-FILE-LEDGER.md#scriptsvitest-count-gatecjs) | 100 / 16 / 3215 | ⚠ **FIRES** | ⚠ **was ABSENT at SIXTEEN phases — on the file that ENFORCES the guardrails** (196). ⚠ Raising a pin necessarily deletes one line; a `grep -c '^-[^-]'` expecting 0 is WRONG |
