...
| [`backend/app/models/connector.py`](docs/HOT-FILE-LEDGER.md#backendappmodelsconnectorpy) | 5 / 3 / 450 | ⚠ **FIRES — CROSSED THE THRESHOLD IN THE COMMIT THAT ADDED THIS ROW** | ⚠ absent for its entire life (added 211) — honoured by construction (211) |
| [`backend/app/services/mcp_client.py`](docs/HOT-FILE-LEDGER.md#backendappservicesmcp_clientpy) | 3 / 3 / 400 | ⚠ **FIRES — CROSSED THE THRESHOLD IN THE COMMIT THAT ADDED THIS ROW** | ⚠ absent for its entire life (added 211) — honoured by construction (211) |
| [`backend/app/api/connectors.py`](docs/HOT-FILE-LEDGER.md#backendappapiconnectorspy) | 6 / 3 / 734 | ⚠ **FIRES — CROSSED THE THRESHOLD IN THE COMMIT THAT ADDED THIS ROW** | ⚠ absent for its entire life (added 211) — honoured by construction (211) |
