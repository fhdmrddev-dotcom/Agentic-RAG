...
// GlobResult (L288-304). Shares summary shape with GrepBody (matches count).

export interface GlobBodyProps {
  parsed: any
}
...
export default function GlobBody({ parsed }: GlobBodyProps) {
