...
| ⛔ Production deploy checklist — migrations **183-192** via SQL editor; `subscription_tier` on BOTH prod orgs **before** the backend ships | `milestones/v4.3-MILESTONE-AUDIT.md` |
