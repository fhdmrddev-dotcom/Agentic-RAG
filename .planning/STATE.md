...
Phase: 190 (live connector slice + connector security — stretch) — **EXECUTING, plan 11 of 19**
...
adapter** whose `CAPABILITY` equals its registry key. Next: `190-12`.)
