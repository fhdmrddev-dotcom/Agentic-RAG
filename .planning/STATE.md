...
Phase: 190 (live connector slice + connector security — stretch) — **EXECUTING, plan 8 of 19**
...
the deeper one returned `ok=True` over a wire carrying `Bcc: attacker@evil.com`.** Next: `190-09`.)
