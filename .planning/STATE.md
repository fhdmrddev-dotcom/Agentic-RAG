...
resume_file: .planning/phases/190-live-connector-slice-connector-security-stretch/190-05-PLAN.md
progress:
  total_phases: 21
  completed_phases: 11
  total_plans: 161
...
Phase: 190 (live connector slice + connector security — stretch) — **EXECUTING, plan 7 of 19**
...
claimed by a plan number — whoever needs it should check `190-08`..`190-19` rather than inherit that
sentence. Next: `190-08`, the adapter protocol + registry + SMTP adapter.)
