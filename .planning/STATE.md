...
**Phase:** **194 Stop a Running Workflow — CONTEXT GATHERED 2026-08-16 (`99b6a5b4`). NEXT = `/gsd:plan-phase 194`.** *(This line read "193.2 From Authored to Runnable — ✅ CLOSED…" until 194 opened, and "193.1 Template-First Authoring" before that; both prior readings are kept.)*
