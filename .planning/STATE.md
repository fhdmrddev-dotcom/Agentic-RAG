...
Phase: 190 (live connector slice + connector security — stretch) — **EXECUTING, plan 10 of 19**
...
and the author's rich document was filed as `OPS-17`.** Two of the three capabilities now resolve to a
real adapter; `post_message` is 190-11's. Next: `190-11`.)
