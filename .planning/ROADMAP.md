...
Plans:
- [ ] 188.2-01-PLAN.md — Wave 0: re-scope all 17 negative fences + 4 haystacks to a six-file subtree source, add the D-09 third-badge `@ts-expect-error` control (asserted NOWHERE before this phase) and the ESM-cycle fence; C-1/C-3/C-4/C-7 observed RED (wave 1, test-only)
