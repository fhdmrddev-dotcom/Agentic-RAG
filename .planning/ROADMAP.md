...
| 095.1 Cross-Provider Run Honesty & Workspace Parity | 5/5 + gap 1/2 | Gap-closure in progress — 095.1-06 (GAP-1 derived-panel reachable) ✅ 2026-06-06; 095.1-07 (GAP-2 live attribution lag) pending. Base 095.1-01..05 shipped (WORKSPACE-PARITY + RUN-HONESTY + PROVIDER-ERR delivered); GAP-1 closed at unit level (WorkspacePanel.hasActivity now reaches useDerivedPanel → derived panel renders for no-write_todos runs, honest count badge, real-panel guard test). Then /gsd:verify-work | - |
