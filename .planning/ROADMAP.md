...
**Plans**: 1 plan
- [ ] 160-01-PLAN.md — Write the Tenancy-Model ADR (ratify D-PRD-02 + lock `is_system_global`/`is_org_shared`/slot-104+ + the 4-tier deploy-flexibility contract) and record it as D-v3.4-01 in DECISIONS.md + PROJECT.md
