...
| 095. Chat Tool-Card Unification | 3/5 | In progress — Plan 01 (foundational primitives: unifiedStepCount/dedupToolCalls D-04 + fileIcon D-07) + Plan 02 (RunCard D-06 persistent timer + D-04 unify all 3 count sites + the one RunStatusStrip) + Plan 03 (D-05 sub-agent zero-duplicate root fix + ToolCallPanel shared dedup + StepRail rail + Round-N divider) shipped 2026-06-05; Plans 04/05 pending | - |
