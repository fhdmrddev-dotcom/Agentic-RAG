...
- [ ] 088-01-PLAN.md — A11y remediation to WCAG 2.1 AA + vitest-axe regression gate (global :focus-visible, targeted aria-live, FilesSection aria-selected fix, axe on 8 panel tests)
...
| 088. Cross-Cutting Verification + Accessibility | 0/5 | Planned | - |
