...
- [ ] 189-10-PLAN.md — The canvas run vocabulary + the 8th ring reading, four arcs and still (D-16, D-07) (wave 4) — ⚠ **its worklist is COMPILER-GENERATED by 189-08 and is SEVEN tables, not four**: `RUN_READING_WORD` (:61, D-16's home) · `STATIC_CLAUSE` (:170) · `RING_GEOMETRY` (:313) · `NodeRunOverlay RING_STROKE` (:134) · `PhaseNode.test ALL_READINGS` (:367) · `PhaseNodeCard.test ALL_READINGS_TABLE` (:178) **and** `CARD_READING_SHAPES` (:2733). **Its `tsc` target is 33, NOT the 40 it inherits.**
