...
| 093. Harness Cross-Provider Parity + Phase-Type Hardening | 2/5 | In progress (093-01 Wave-0 substrate + 093-02 task_service gateway-consumption rewrite [F9 core/SC#1] complete 2026-06-02: open_stream + calling_mode honored, STRUCTURED inject-once + post-parse, deterministic byte-identical-Deep guard net-new=0; 093-03 ‖ remaining; PARITY-02 stays OPEN — phase verification owns closure) | - |
