...
- [ ] 166-01-PLAN.md — Backend authz + org router (get_active_org_id X-Org-Id validation · require_org_manage · /org/me (carries memberships[]) · /org/members · /org/audit service-role+app-authz+run_in_threadpool) [Wave 1]
