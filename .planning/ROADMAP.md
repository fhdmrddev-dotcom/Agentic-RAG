...
- [ ] 095-01-PLAN.md — Foundational shared primitives: `unifiedStepCount` + extracted `dedupToolCalls` (D-04) + `fileIcon` (D-07) + Wave-0 tests [Wave 1]
...
| 095. Chat Tool-Card Unification | 0/5 | Planned     | - |
