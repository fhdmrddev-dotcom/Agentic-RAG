...
- [ ] 188.2-04-PLAN.md — Create additively: `phaseNodeCardContract.ts` (the 6 slot types) and `ownProperty.ts` (a zero-import leaf), both verbatim moves, nothing deleted (wave 3)
