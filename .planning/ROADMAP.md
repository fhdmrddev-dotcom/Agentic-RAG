...
- [x] **Phase 248: The Credential Boundary** — a secret pasted into a non-secret field is refused not stored, the grant marker claims only what is knowable, all 13 anon-executable SECDEF functions ruled on, `get_advisors(security)` in the deploy checklist (CRED-01..04). ⚠ **Box corrected at the v4.2 milestone audit (2026-09-16): it read `[ ]` while the Progress row read ✅ CLOSED 2026-09-15 and `248-VERIFICATION.md` carried a peer-reviewed 4/4.** The drift this file warns about at line 265, in this file. ⛔ **`CRED-01` and `CRED-03` were then REOPENED by the same audit** — see Phase 252
...
| **252. Close the v4.2 audit gaps** | 0/? | ⏳ **NOT STARTED — added 2026-09-16 by the milestone audit.** `.planning/v4.2-MILESTONE-AUDIT.md` closed `gaps_found`: **4 blockers · 9 warnings · flows 1/3 · integration 16/22**, across five phases whose own verifications all read `passed`. ⛔ It moved **`CRED-01`, `CRED-03`, `WATCH-04` and `HONEST-03`** from ✅ satisfied to ⛔ unsatisfied. Next: `/gsd:discuss-phase 252` | re-closes CRED-01, CRED-03, WATCH-04, HONEST-03 |

⚠ **5 / 5 v4.2 phases closed · 15 / 26 requirements satisfied · 6 partial · 5 unsatisfied.**
