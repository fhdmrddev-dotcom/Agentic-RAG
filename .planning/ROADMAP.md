...
- [ ] 185-12-PLAN.md — BUG-260730-01: the auto-attached citation gate demanded inline markers nothing asked the model to write; state the format in one home, tell the producer on both agent paths, keep the gate strict
