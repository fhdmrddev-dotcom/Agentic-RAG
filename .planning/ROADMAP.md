...
- [x] **Phase 260: The Expert You Can Actually Use** — an Expert selectable in chat that visibly scopes the thread, ships its "Try asking…" prompts, and one first-party Financial Analyzer driven end to end as a real conversation (PACK-02, PACK-03, PACK-05)
