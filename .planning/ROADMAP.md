...
- [ ] 188.2-06-PLAN.md — THE CUT: delete the seven ranges, wire three terse call sites, re-point both importers with no shim, rewrite the docblock (door b), and measure D-03's three numbers with the named classifier (wave 5)
