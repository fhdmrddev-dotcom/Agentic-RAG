...
- [ ] 188.2-07-PLAN.md — Close: flip the G-5 ledger row, correct three stale doc pointers, one upward pin move, and drive BOTH UAT boards with disjoint evidence (wave 6, has checkpoints) — **PARTIAL 2026-08-07: Task 1 DONE (`615b2a06`), Tasks 2–3 BLOCKED at an operator checkpoint. Stays unchecked.**
