...
- [ ] 188.2-07-PLAN.md — Close: flip the G-5 ledger row, correct three stale doc pointers, one upward pin move, and drive BOTH UAT boards with disjoint evidence (wave 6, has checkpoints)
