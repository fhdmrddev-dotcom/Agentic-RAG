...
- [ ] 188.2-02-PLAN.md — BUG-260806-01, its own plan as the NAMED exception to the prove-unchanged contract: `AFFORDANCE_Z = 1002` on all three affordance groups, a three-part unit guard, and the one authorised `AFFORDANCE_SHAPE_BASELINE` re-capture (wave 1, parallel — disjoint files)
