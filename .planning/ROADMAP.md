...
- [x] **Phase 257: Cost in Dollars, and What It Cannot See** — an effective-dated rate registry, ONE token→USD conversion, and an operator view of spend per run and per org that states what it cannot see (METER-01, METER-02, METER-07)
