...
| 200.1 | **(INSERT)** The Run Says What It Produced | The run surface names its deliverable BY TYPE (file / text / both / neither), and the log's live line looks live | RUN-04 | 5 |
