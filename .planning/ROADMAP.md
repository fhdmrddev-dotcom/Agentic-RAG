...
**Plans**: 5 plans (planned 2026-05-07 via /gsd:plan-phase 067; wave-structured by file ownership and dependency)
  - [ ] 067-01-state-machine-cleanup-PLAN.md — Wave 1: useMessages.ts terminal-flip guards (existence-check on assistantId/targetId in BOTH sendMessage and reconcile onTerminal blocks) + delete "Saving response…" fallback at MessageItem.tsx:140 (D-067-01, D-067-02)
  ...
  - [ ] 067-03-runs-xread-cancellation-cleanup-PLAN.md — Wave 1 (parallel to 01): runs.py module-top `from redis.exceptions import RedisError, TimeoutError as RedisTimeoutError` + differentiated handlers at three xread sites (lines 104, 163, 184): asyncio.CancelledError re-raise, RedisTimeoutError INFO-only, RedisError keep traceback (D-067-04)
  - [ ] 067-04-stopgap-env-removal-PLAN.md — Wave 1 (parallel to 01, 03): one-line delete of RUN_HARD_TIMEOUT_SECONDS from backend/.env + cosmetic clean of backend/.env.example, supabase/SETUP.md, REDIS-SETUP.md (D-067-06; preserve config.py:366 dead-code comment + test_061_hard_timeout.py:44 test docstring)
