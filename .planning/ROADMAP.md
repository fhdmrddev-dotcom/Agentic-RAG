...
- [ ] 188.2-03-PLAN.md — Capture `CARD_HTML_BASELINE` + the reading/verdict geometry matrices on the **UNMOVED** tree, twice-agreeing, C-6 RED on two instruments (wave 2, test-only)
