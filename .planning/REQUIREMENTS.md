...
- [x] **UI-07**: Selecting a folder in the ingestion UI shows a compact info bar with folder stats (document count, total size, global badge, creation date)
...
| Searching raw uploaded files | Only extracted markdown is searchable |
| Switching to Docling | Existing pypdf + python-docx pipeline works; no migration risk |
