...
| 233 | the-source-says-what-it-did | Can all four surfaces coexist without shouting over each other — and is the path from "something is off" to "I clicked the thing that fixes it" short and unbranching? | _pending_ — fork is **where the fix lives**: A popover repairs in place · B badge is only a door | phase-235, lib-10, surf-02, surf-03, seed-239, seed-248, g2-sketch-gate, notification-surface |
