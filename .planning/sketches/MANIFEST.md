...
| 233 | the-source-says-what-it-did | With twelve sources connected and two needing you, how much should a HEALTHY source say? | _pending_ — A full card each vs B one line each (**50% less visible text**). ⚠ The FIRST fork (where the fix lives) was REFUTED: 248 chars differed out of 30,000 and the landing screens were pixel-identical | phase-235, lib-10, surf-02, surf-03, seed-239, seed-248, g2-sketch-gate, notification-surface |
