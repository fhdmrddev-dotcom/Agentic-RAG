...
## Next Milestone: v2.8 Harness Engine & Plugin Contract (not started)

**Planned scope** (deferred from the v2.7 PRD split — see Future Requirements in the archived `milestones/v2.7-REQUIREMENTS.md`): a state-machine workflow runtime (HARNESS-01..03), a plugin contract with 6 extension types (PLUGIN-01..03), and dual-mode Deep/Harness UX (MODE-01) — plus the v2.7 carry-forwards above. Run `/gsd:new-milestone` to formalize requirements → roadmap.

## Current State

**Shipped:** v2.7 (Agent Workspace & Panel) — 2026-05-30 (6 phases, 28 plans, 226 commits, ~52K LOC delta)
**Next:** v2.8 Harness Engine & Plugin Contract — not started (run `/gsd:new-milestone`)
...
### Active (v2.8 — Harness Engine & Plugin Contract)

*Next milestone — requirements not yet formalized. Planned themes: HARNESS-01..03 (state-machine workflow runtime), PLUGIN-01..03 (plugin contract, 6 extension types), MODE-01 (dual Deep/Harness mode). See Future Requirements in the archived `milestones/v2.7-REQUIREMENTS.md` plus the v2.7 carry-forwards above. Run `/gsd:new-milestone`.*
