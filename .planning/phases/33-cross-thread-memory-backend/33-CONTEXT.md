...
- **D-05:** Memory block is injected **after the main SYSTEM_PROMPT body, before the skill catalog block**, using the same string-append pattern already in threads.py (lines 463-484).
- **D-06:** Format:
  ```
  ## User Memory
