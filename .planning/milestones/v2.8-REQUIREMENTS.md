> **ARCHIVED 2026-06-07** — v2.8 (Harness Engine & Workflow Mode) shipped. 25/25 active requirements Validated (PARITY-01 re-deferred by design). This is the frozen requirements snapshot for the milestone; the live `.planning/REQUIREMENTS.md` is reset fresh for the next milestone.
