# ROADMAP archive — v3.7 Workflow Product Completion

> Snapshot of the v3.7 section of `.planning/ROADMAP.md`, taken at the milestone close
> (2026-08-24, commit `2f513ff9`). The live `ROADMAP.md` was NOT modified to produce this
> file — v3.8 was already active in it and other sessions were editing it, so the section
> was COPIED rather than cut. It also still carries its own in-file
> `## Prior Milestone Archive: v3.7` section; this file is the standalone archive every
> prior milestone has.
