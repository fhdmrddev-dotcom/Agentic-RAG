...
- [x] 166-04-PLAN.md — OrgAdminShell composition (3 live + 4 LockedTab tabs · lazy per-tab fetch · scope-threaded audit degrade) [Wave 3]
- [x] 166-05-PLAN.md — Identity anchor + reachability (079-C ProfileMenu · indigo Shield-mirror · ChatLayout org-admin mount) [Wave 4]
**UI hint**: yes
...
- [x] 168-05-PLAN.md — Frontend data + auth layer (api SSO fns · canManageSso fail-closed flag · `signInWithSSO` · SSO-session JIT provision-then-reprobe)
- [x] 168-06-PLAN.md — SSO tab live in the 166 shell + identifier-first `SignInForm` (password fallback retained)
**UI hint**: yes
