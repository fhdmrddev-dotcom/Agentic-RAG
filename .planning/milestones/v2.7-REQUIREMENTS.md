# Requirements Archive: v2.7 Agent Workspace & Panel
...
- [x] **PANEL-05**: Panel subscribes to the same SSE stream as chat via StreamsProvider Context — single subscription, demultiplexed by event type, no duplicate connections
- [x] **PANEL-06**: Panel events route to separate state stores — no chat message list re-renders triggered by panel updates
...
| PANEL-05 | Phase 086 | Complete |
| PANEL-06 | Phase 086 | Complete |
