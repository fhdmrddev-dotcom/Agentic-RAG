...
- [x] **Phase 32.5: Retrieval Quality & Chunking Fixes** — Structure-aware chunker rewrite, context-enriched embeddings, retrieval-time deduplication, confidence threshold recalibration (completed 2026-04-18)
...
| 32.5. Retrieval Quality & Chunking Fixes | v2.2 | 4/4 | Complete | 2026-04-18 |
