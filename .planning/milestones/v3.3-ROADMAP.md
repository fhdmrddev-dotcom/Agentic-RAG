...
- [x] **Phase 159 (STRETCH): Model Registry Curation** — discovery filtered to chat/tool-capable models + add-model-by-ID with capabilities + sensible defaults (MODEL-03) — completed 2026-07-18 (live UAT 6/6 Chrome-MCP; secure-phase 14/14 CLOSED; BUG-260718-01 closed)
