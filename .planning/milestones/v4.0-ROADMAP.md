...
> &nbsp;
> ⚠ **CORRECTED 2026-09-13 (Phase 245) — the paragraph above is preserved, not deleted. It was FALSE
> ON THE DAY THIS MILESTONE CLOSED, and that is the finding.** *"238's nine live rows need one Azure
> app registration"*: All nine of 238's M rows were **DRIVEN LIVE on 2026-09-07** (`238-VERIFICATION.md:213-231` — 7 full pass, 2 half at the time; **four defects found by driving and NONE by the 15-case unit suite**). The operator completed the Azure registration *hours after* `238-SUMMARY.md` was written. Driven **2026-09-07**; v4.0 closed
> **2026-09-10**. ✅ Phase 245 closed the set (`.planning/phases/245-…/245-VERDICT.md` §SC#1).
> ⛔ The *241 row 5 needs a read-capable cloud DSN* half **remains true**, deadline included.
...
| 238. Microsoft Graph — OneDrive (⚠ **CORRECTED 2026-09-13**) | 3/3 | ⚠ **CORRECTED 2026-09-13 (Phase 245) — the row above is preserved, not deleted. It was FALSE ON THE DAY v4.0 CLOSED.** *"ALL 9 LIVE UAT ROWS OWED on ONE operator prerequisite"*: All nine of 238's M rows were **DRIVEN LIVE on 2026-09-07** (`238-VERIFICATION.md:213-231` — 7 full pass, 2 half at the time; **four defects found by driving and NONE by the 15-case unit suite**). The operator completed the Azure registration *hours after* `238-SUMMARY.md` was written. The rows were driven **2026-09-07**; v4.0 closed **2026-09-10**. ✅ Phase 245 closed the set — **8 PASS · 1 ⛔ BLOCKED (M-9, `BUG-260913-01`) · 2 ⛔ RETIRED (S-1/S-2, `SEED-256` — a written retirement, no longer a block) · 0 HALF**. ⭐ **This row's own SEED-253 note — *"Graph populates `path`; Drive still cannot"* — was RIGHT, and `245-02` turned it into a measured, filed defect with a blast radius: every path-based classification rule is silently inert for every Google Drive document.** ⛔ The **REVIEW OWED** half stands: no independent §6.3 review has happened, and DEBT-03 was only ever *"say so in the record"* | 2026-09-13 |
