...
async def _handle_render_template(args: dict, ctx: ToolContext) -> ToolResult:
    ...
    out_filename = (args.get("out_filename") or "deliverable.docx").strip() or "deliverable.docx"
    ...
    src_name = src.get("filename") or out_filename
    ...
    def _ship_and_run() -> dict:
        ...
        cmd = (
            f"python -u {container_driver} {engine} "
            f"{container_template} {container_field_map} {container_out}"
        )
