...
from app.api import threads, runs, documents, settings as settings_api, folders, kb, skills, audit, knowledge_health, feedback, sandbox_outputs, workspace, admin, panel, workflows, metadata_fields, document_views, document_relationships, classification_rules, document_governance, skill_tuner, skill_test_cases, evals, features, setup as setup_api, org, me_preferences, canvas_canary  # noqa: E402
...
app.include_router(canvas_canary.router)  # Phase 181 REVERT-01 (D-181-04) — TEMPORARY /canvas/ping canary proving require_canvas's 404-when-off gate (removed/repurposed when the first real canvas route lands in 182/183)
