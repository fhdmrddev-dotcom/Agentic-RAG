...
Reference full template: `C:/Vibe Apps/Agentic RAG/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `C:/Vibe Apps/Agentic RAG/.claude/get-shit-done/templates/state.md`.
