...
<execution_context>
@C:/Vibe Apps/Agentic RAG/.claude/get-shit-done/workflows/docs-update.md
</execution_context>
...
<process>
Execute the docs-update workflow from @C:/Vibe Apps/Agentic RAG/.claude/get-shit-done/workflows/docs-update.md end-to-end.
