...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `C:/Vibe Apps/Agentic RAG/.claude/skills/.gsd-surface.json`
...
```bash
# Claude Code
RUNTIME_CONFIG_DIR=C:/Vibe Apps/Agentic RAG/.claude/skills

# Resolve commandsDir and agentsDir
COMMANDS_DIR=C:/Vibe Apps/Agentic RAG/.claude/commands/gsd
AGENTS_DIR=C:/Vibe Apps/Agentic RAG/.claude/agents
```
...
<execution_context>
Surface state file: `C:/Vibe Apps/Agentic RAG/.claude/skills/.gsd-surface.json`
Install profile marker: `C:/Vibe Apps/Agentic RAG/.claude/skills/.gsd-profile`
Engine module: `C:/Vibe Apps/Agentic RAG/.claude/get-shit-done/bin/lib/surface.cjs`
Cluster definitions: `C:/Vibe Apps/Agentic RAG/.claude/get-shit-done/bin/lib/clusters.cjs`
</execution_context>
