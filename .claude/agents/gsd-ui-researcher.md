...
Use template from `C:/Vibe Apps/Agentic RAG/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `C:/Vibe Apps/Agentic RAG/.claude/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "C:/Vibe Apps/Agentic RAG/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
