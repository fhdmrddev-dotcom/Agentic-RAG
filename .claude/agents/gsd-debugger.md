...
<required_reading>
@C:/Vibe Apps/Agentic RAG/.claude/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@C:/Vibe Apps/Agentic RAG/.claude/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = C:/Vibe Apps/Agentic RAG/.claude
                  → checks C:/Vibe Apps/Agentic RAG/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = C:/Vibe Apps/Agentic RAG/.claude/get-shit-done
                  → writes to C:/Vibe Apps/Agentic RAG/.claude/get-shit-done/hooks/
...
@C:/Vibe Apps/Agentic RAG/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @C:/Vibe Apps/Agentic RAG/.claude/get-shit-done/references/common-bug-patterns.md
