...
INSTALL_JS_GLOBAL="C:/Vibe Apps/Agentic RAG/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node C:/Vibe Apps/Agentic RAG/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
