...
```bash
cp "C:/Vibe Apps/Agentic RAG/.claude/get-shit-done/USER-PROFILE.md" "C:/Vibe Apps/Agentic RAG/.claude/USER-PROFILE.backup.md"
```
...
```bash
BACKUP_PATH="C:/Vibe Apps/Agentic RAG/.claude/USER-PROFILE.backup.md"
```
