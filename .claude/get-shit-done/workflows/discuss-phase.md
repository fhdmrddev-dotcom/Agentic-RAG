...
<required_reading>
@C:/Vibe Apps/Agentic RAG/.claude/get-shit-done/references/domain-probes.md
@C:/Vibe Apps/Agentic RAG/.claude/get-shit-done/references/gate-prompts.md
@C:/Vibe Apps/Agentic RAG/.claude/get-shit-done/references/universal-anti-patterns.md
</required_reading>
...
- Read and execute @C:/Vibe Apps/Agentic RAG/.claude/get-shit-done/workflows/discuss-phase-power.md end-to-end
...
```bash
PROFILE_CONTENT=$(cat "C:/Vibe Apps/Agentic RAG/.claude/get-shit-done/USER-PROFILE.md" 2>/dev/null || true)
```
...
**Full step-by-step instructions:** @C:/Vibe Apps/Agentic RAG/.claude/get-shit-done/workflows/discuss-phase-power.md
